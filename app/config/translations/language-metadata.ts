...
// =============================================================================
//
// Ported verbatim from the 22slots reference app. Pure data catalogue (exempt from
// the 200-line rule, app/CLAUDE.md §12). Feeds the Platform panel's language picker
// (step 117) and the translations config below.
