    ...
    >
      ...
      >
        <div className="flex items-center gap-2">
          {insecure && (
            <span
              title="This project is served over plain HTTP on its IP address. To attach a custom domain and switch to HTTPS / Secure mode, open the Settings menu → Personal Domain and follow the wizard."
