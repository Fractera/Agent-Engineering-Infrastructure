...
// The workspace glossary editor (moved from the slot in step 170). Approve
// abbreviations / preferred phrasings so every agent reads them the same way and
// avoids mistakes — e.g. "aws" -> "ai-workspace". Left = key/abbreviation, right =
// value/meaning. Persisted in the slot's GLOSSARY.md file (read by every agent as
// project context); an agent later exports/ingests it into Company Brain.
      ...
      <div className="mx-auto max-w-3xl px-6 py-10">
        ...
        <div className="mt-4 rounded-lg border border-border bg-muted/20 p-3">
          ...
          <p className="mt-1 text-[11px] leading-relaxed text-foreground/70">
            A real file at the project (slot) root — the same level as the agent context files
