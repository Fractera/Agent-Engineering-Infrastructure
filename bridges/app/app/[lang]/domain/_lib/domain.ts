...
// Имена, которые владелец заводит у регистратора. Список фиксирован: это те же
// восемь записей, которые покрывает сертификат.
export const DNS_HOSTS: { name: string; noteKey: string }[] = [
  ...
  { name: "hermes", noteKey: "hermes" },
  { name: "chat", noteKey: "chat" },
];
