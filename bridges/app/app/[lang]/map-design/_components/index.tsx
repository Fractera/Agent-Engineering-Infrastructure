...
export function DesignMap({ lang, s }: { lang: string; s: AdminStrings }) {
  ...
  const rows = [
    ...
    // 🪦 ПЯТАЯ СТРОКА — КАТАЛОГ СЕКЦИЙ — УБРАНА 2026-08-29 (шаг 39-1). Раздел удалён из
    // панели по слову владельца, а строка карты, ведущая на удалённый раздел, — тупик:
    // человек видит пункт, нажимает и не попадает никуда.
  ];
