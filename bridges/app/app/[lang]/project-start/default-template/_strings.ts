 ...
 *
 * 🔒 16 → 11 (28-31, 2026-08-29). Владелец назвал конец пути: десятый шаг —
 * последний рабочий («реально связанные с разработкой это будет последний шаг»),
 * одиннадцатый — прощание и пара советов. Оставить 16 значило бы обещать
 ...
 * страницами. Шкала прогресса рисует одиннадцать отрезков (задумано), но
 ...
 */
export const DEFAULT_TEMPLATE_BUILT = 11;
