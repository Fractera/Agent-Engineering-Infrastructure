...
export function whatYourAddressMeans(lang: string, siteUrl: string | null): string {
  const ru = siteUrl
    ? `Этот адрес — ${siteUrl} — принадлежит вашему серверу, а не нам и не прежнему владельцу проекта. По нему теперь отдаётся то, что приехало из репозитория-донора: панель заменила содержимое слота и собрала проект заново. Прежний владелец о вашем сервере ничего не знает, и его репозиторий с вашим больше не связан — история была отсечена на предыдущем шаге. Всё, что вы дальше измените в проекте, будет видно здесь же.`
    : `Адрес, по которому открывается ваш проект, принадлежит вашему серверу, а не нам и не прежнему владельцу проекта. По нему теперь отдаётся то, что приехало из репозитория-донора: панель заменила содержимое слота и собрала проект заново. Прежний владелец о вашем сервере ничего не знает, и его репозиторий с вашим больше не связан — история была отсечена на предыдущем шаге. Сейчас сервер своего внешнего адреса не знает: домен ему ещё не назначен, и назвать вам адрес наугад мы не станем.`;
  const en = siteUrl
    ? `This address — ${siteUrl} — belongs to your server, not to us and not to the project's previous owner. It now serves what arrived from the donor repository: the panel replaced the slot's contents and built the project anew. The previous owner knows nothing about your server, and his repository is no longer linked to yours — the history was cut on the previous step. Everything you change in the project from now on will show up right here.`
    : `The address your project opens at belongs to your server, not to us and not to the project's previous owner. It now serves what arrived from the donor repository: the panel replaced the slot's contents and built the project anew. The previous owner knows nothing about your server, and his repository is no longer linked to yours — the history was cut on the previous step. Right now the server does not know its own outside address: no domain has been assigned to it yet, and we will not guess one for you.`;
