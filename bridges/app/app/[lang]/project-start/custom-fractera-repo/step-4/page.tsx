...
import { adoptLiveStrings, whatYourAddressMeans } from "../_live";
...
export default async function CustomFracteraRepoStepThree(
  ...
  const locked = adoptLockedFor(lang, 4);
  if (locked) {
    return (
      <PageShell
        lang={lang}
        ...
        <div className="flex flex-col gap-4">
          ...
          {marked ? (
            <StepNav
              ...
              nextHref={adoptStepBuilt(5) ? `${base}/step-5` : undefined}
