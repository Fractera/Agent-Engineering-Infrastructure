...
// `https://admin.aifa.dev/ru/project-start`.
//
// 🔒 ОН СКАЗАЛ, КАКАЯ ОСТАЁТСЯ, 2026-08-29: эта. Старая вкладка `/[lang]/github`
// удалена целиком («мы уже переехали на первую вкладку запуск проекта, а вторую
// нужно немедленно удалить»), и этот раздел — единственный путь запуска проекта.
// Сюда же ведёт тревога «требуется соединить с GitHub» из `admin-warnings.ts`.
//
