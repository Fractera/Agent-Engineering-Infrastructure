// Документ «Единственный агент» — `SINGLE-AGENT.md` (2026-08-10).
//
// ЗАДАННЫЙ документ и первый ДОКУМЕНТ-ЗАПРЕТ в корпусе: он не требует действия,
// а отнимает право. Поэтому у него есть КОМАНДА активации — способ снять запрет
// на одну задачу, не заходя в панель.
//
// Команда показывается и правится на карте документов, вместе с командами всех
// остальных: словарь обязан читаться с одного экрана.
...
const DOC_KEY = "doc-single-agent" as const;
