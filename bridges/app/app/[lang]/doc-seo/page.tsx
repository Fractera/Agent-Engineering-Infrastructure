// Документ разработки «doc-seo» — как устроена поисковая оптимизация проекта (шаг 503).
