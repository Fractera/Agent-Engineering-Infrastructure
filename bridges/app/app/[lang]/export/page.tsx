...
// до килобайта.
//
// Размеры читает сервер тем же `partSize` из `lib/backup-parts`, которым живёт
// сама выгрузка, — один источник правды о том, из чего состоит резервная копия.
// (Маршрут `/api/data/export/manifest`, отвечавший размерами старой панели,
// удалён на переключении Ф3: страница считает их сама, на сервере.)
