...
export function StepForm({
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      {/* 🪦 ЗДЕСЬ СТОЯЛ БЛОК РЕКОМЕНДОВАННЫХ ПРОЕКТОВ (35-1а), И ОН УДАЛЁН 75-6.
          Он решал задачу ПРЕЖНЕЙ модели: донора мы не проверяем, значит дадим
          безопасный выбор. Модель форка отменила задачу — человек форкает СВОЙ
          проект, — и блок начал спорить со строкой, стоящей выше, да ещё и нёс ту
          же подпись «Сделать форк», что и главное действие шага.
          🔒 Способность, построенная под отменённый замысел, не становится
          нейтральной: она противоречит новому, и человек читает это как поломку
          в себе. Слова владельца: «выглядит невероятно глупо сложно и
          противоречиво». */}
