      ...
      {editing ? (
        <>
          ...
          {/* Микрофон ПОД полем — там, где стоит курсор, и там же появится текст.
              Кнопка удерживается: отпустил — запись ушла на расшифровку, а её
              результат показан рядом и ждёт нажатия «Вставить».

              Блок ВЕРТИКАЛЬНЫЙ и во всю ширину намеренно: инструмент растит
              полосу звука на всё доступное место, и во флекс-строке рядом с
              подсказкой ей было некуда расти — эквалайзер схлопывался в точку. */}
