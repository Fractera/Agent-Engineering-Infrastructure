...
export type CreateAutomationStrings = {
  ...
  // step 301 — the after-birth notice: the description is authored in the use-cases Quiz; prefix/suffix wrap
  // the bold, untranslated language name.
  afterBirthNoticePrefix: string; afterBirthNoticeSuffix: string;
...
export const CREATE_AUTOMATION_I18N: Record<string, CreateAutomationStrings> = {
  en: {
    ...
    categoryCreatedDesc: "Its hub page is being built (3-4 min); you can already put an automation in it.",
    ...
    automationCreated: "Automation created — building the page (3-4 min).",
    automationCreatedDesc: "It opens frozen on an empty canvas — go to its use-cases and describe how it should work.",
    errNameRequired: "Give the automation a name — the name is required.",
  ...
  ru: {
    ...
    categoryCreatedDesc: "Её страница-хаб строится (3-4 мин); автоматизацию в неё уже можно добавить.",
    ...
    automationCreated: "Автоматизация создана — страница строится (3-4 мин).",
    automationCreatedDesc: "Она откроется замороженной на пустом холсте — перейдите к её кейсам и опишите, как она должна работать.",
    errNameRequired: "Дайте автоматизации название — имя обязательно.",
  ...
  es: {
    ...
    categoryCreatedDesc: "Su página central se está construyendo (3-4 min); ya puedes poner una automatización en ella.",
    ...
    automationCreated: "Automatización creada — construyendo la página (3-4 min).",
    automationCreatedDesc: "Se abre congelada en un lienzo vacío — ve a sus casos de uso y describe cómo debe funcionar.",
    errNameRequired: "Ponle un nombre a la automatización — el nombre es obligatorio.",
  ...
  fr: {
    ...
    categoryCreatedDesc: "Sa page centrale est en cours de construction (3-4 min) ; vous pouvez déjà y placer une automatisation.",
    ...
    automationCreated: "Automatisation créée — construction de la page (3-4 min).",
    automationCreatedDesc: "Elle s'ouvre gelée sur un canevas vide — allez dans ses cas d'usage et décrivez ce qu'elle doit faire.",
    errNameRequired: "Donnez un nom à l'automatisation — le nom est obligatoire.",
  ...
  it: {
    ...
    categoryCreatedDesc: "La sua pagina hub è in costruzione (3-4 min); puoi già inserirvi un'automazione.",
    ...
    automationCreated: "Automazione creata — costruzione della pagina (3-4 min).",
    automationCreatedDesc: "Si apre congelata su una tela vuota — vai ai suoi casi d'uso e descrivi come deve funzionare.",
    errNameRequired: "Dai un nome all'automazione — il nome è obbligatorio.",
  ...
  de: {
    ...
    categoryCreatedDesc: "Ihre Hub-Seite wird gerade gebaut (3-4 Min.); du kannst schon jetzt eine Automatisierung hineinlegen.",
    ...
    automationCreated: "Automatisierung erstellt — die Seite wird gebaut (3-4 Min.).",
    automationCreatedDesc: "Sie öffnet sich eingefroren auf leerer Leinwand — geh zu ihren Use-Cases und beschreibe, was sie tun soll.",
    errNameRequired: "Gib der Automatisierung einen Namen — der Name ist erforderlich.",
  ...
  pt: {
    ...
    categoryCreatedDesc: "A sua página principal está a ser construída (3-4 min); já pode colocar lá uma automação.",
    ...
    automationCreated: "Automação criada — a construir a página (3-4 min).",
    automationCreatedDesc: "Abre congelada numa tela vazia — vá aos seus casos de uso e descreva como deve funcionar.",
    errNameRequired: "Dê um nome à automação — o nome é obrigatório.",
  ...
  pl: {
    ...
    categoryCreatedDesc: "Jej strona główna jest w budowie (3-4 min); możesz już umieścić w niej automatyzację.",
    ...
    automationCreated: "Automatyzacja utworzona — strona jest budowana (3-4 min).",
    automationCreatedDesc: "Otwiera się zamrożona na pustym płótnie — przejdź do jej przypadków użycia i opisz, jak ma działać.",
    errNameRequired: "Nadaj automatyzacji nazwę — nazwa jest wymagana.",
  ...
  tr: {
    ...
    categoryCreatedDesc: "Ana sayfası inşa ediliyor (3-4 dk); şimdiden içine bir otomasyon koyabilirsin.",
    ...
    automationCreated: "Otomasyon oluşturuldu — sayfa inşa ediliyor (3-4 dk).",
    automationCreatedDesc: "Boş bir tuvalde donmuş olarak açılır — kullanım senaryolarına git ve ne yapması gerektiğini anlat.",
    errNameRequired: "Otomasyona bir ad ver — ad zorunludur.",
  ...
  nl: {
    ...
    categoryCreatedDesc: "De hubpagina wordt gebouwd (3-4 min); je kunt er al een automatisering in plaatsen.",
    ...
    automationCreated: "Automatisering aangemaakt — pagina wordt gebouwd (3-4 min).",
    automationCreatedDesc: "Ze opent bevroren op een leeg canvas — ga naar haar use-cases en beschrijf wat ze moet doen.",
    errNameRequired: "Geef de automatisering een naam — de naam is verplicht.",
