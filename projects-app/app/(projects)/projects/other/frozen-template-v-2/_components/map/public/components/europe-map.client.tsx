...
//
// 🔒 shadcn: ящик — `Sheet`, иконка — lucide `MapPin`. Пин — РОДНОЙ `<button>` (как в v1): shadcn Button
// ломал клик по пину (см. комментарий у кнопки ниже), а примитива «пин карты» в наборе нет.
