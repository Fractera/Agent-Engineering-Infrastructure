...
export default function AutomationChrome({
  ...
  // В оглавлении — ВСЕ показанные разделы, ровно тот же список, что в кокпите (владелец заметил, что
  // записей было меньше правильного числа: я отбрасывал разделы без сущностей — например диаграмму).
  // Раздел без сущностей остаётся строкой без раскрывашки: он есть на странице, значит есть и в оглавлении.
