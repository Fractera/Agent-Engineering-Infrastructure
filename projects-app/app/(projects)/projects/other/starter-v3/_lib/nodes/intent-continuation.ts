...
// ДВАЖДЫ внутри доменных узлов (`dedupeGuard` и `dimensionTag`, у каждого свой `pending`) — ровно потому,
// что класса не было в архитектуре, и он всплывал копиями там, где понадобился.
