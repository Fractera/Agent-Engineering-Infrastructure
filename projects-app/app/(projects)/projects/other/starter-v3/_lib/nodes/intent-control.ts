...
// доменную логику — `defineDimension` и `defineGlossary` меняли структуру, притворяясь узлами предметной
// области. Управляющий запрос отличается от запроса данных и обязан быть отдельным классом.
