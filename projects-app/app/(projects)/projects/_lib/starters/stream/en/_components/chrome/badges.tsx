...
// Поверхность одна — кокпит (шаг 300: `?view=public`/surface удалены), поэтому набор всегда полный:
// тип · жизненный цикл · шаринг.
const pill = "inline-flex items-center rounded-full px-2 py-0.5 text-xs font-medium capitalize whitespace-nowrap";

export default function Badges({ passport }: { passport: Passport }) {
  const items = [
