...
// (187.9), and the Telegram bot-token how-to tooltip. Add a language by adding its code below; unlisted languages fall back to en.
...
export type ProjectTabStrings = {
  ...
  // Telegram bot-token how-to tooltip (BotFather)
...
const EN: ProjectTabStrings = {
  ...
  telegramTooltip:
    "Create your own bot in Telegram: open @BotFather, send the /newbot command, copy the token it gives you and paste it here.",
};
...
export const STRINGS: Record<string, ProjectTabStrings> = {
  ...
  ru: {
    ...
    telegramTooltip:
      "Создайте своего бота в Telegram: откройте @BotFather, отправьте команду /newbot, скопируйте выданный токен и вставьте его сюда.",
  },
  es: {
    ...
    telegramTooltip:
      "Crea tu propio bot en Telegram: abre @BotFather, envía el comando /newbot, copia el token que te da y pégalo aquí.",
  },
  fr: {
    ...
    telegramTooltip:
      "Créez votre propre bot dans Telegram : ouvrez @BotFather, envoyez la commande /newbot, copiez le jeton fourni et collez-le ici.",
  },
  de: {
    ...
    telegramTooltip:
      "Erstellen Sie Ihren eigenen Bot in Telegram: Öffnen Sie @BotFather, senden Sie den Befehl /newbot, kopieren Sie das erhaltene Token und fügen Sie es hier ein.",
  },
  pt: {
    ...
    telegramTooltip:
      "Crie seu próprio bot no Telegram: abra o @BotFather, envie o comando /newbot, copie o token recebido e cole-o aqui.",
  },
  it: {
    ...
    telegramTooltip:
      "Crea il tuo bot in Telegram: apri @BotFather, invia il comando /newbot, copia il token ricevuto e incollalo qui.",
  },
  uk: {
    ...
    telegramTooltip:
      "Створіть свого бота в Telegram: відкрийте @BotFather, надішліть команду /newbot, скопіюйте отриманий токен і вставте його сюди.",
  },
  pl: {
    ...
    telegramTooltip:
      "Utwórz własnego bota w Telegramie: otwórz @BotFather, wyślij komendę /newbot, skopiuj otrzymany token i wklej go tutaj.",
  },
  tr: {
    ...
    telegramTooltip:
      "Telegram'da kendi botunuzu oluşturun: @BotFather'ı açın, /newbot komutunu gönderin, verilen jetonu kopyalayıp buraya yapıştırın.",
  },
  ar: {
    ...
    telegramTooltip:
      "أنشئ بوتك الخاص في تيليجرام: افتح @BotFather، أرسل الأمر /newbot، ثم انسخ الرمز الذي تحصل عليه والصقه هنا.",
  },
  zh: {
    about: "关于此项目",
    diagram: "流程图",
    ...
    telegramTooltip:
      "在 Telegram 中创建你自己的机器人：打开 @BotFather，发送 /newbot 命令，复制它返回的令牌并粘贴到这里。",
  },
  ja: {
    about: "このプロジェクトについて",
    diagram: "プロセス図",
    ...
    telegramTooltip:
      "Telegram で自分のボットを作成します。@BotFather を開いて /newbot コマンドを送信し、発行されたトークンをコピーしてここに貼り付けてください。",
  },
  ko: {
    about: "이 프로젝트 정보",
    diagram: "프로세스 다이어그램",
    ...
    telegramTooltip:
      "Telegram에서 직접 봇을 만드세요. @BotFather를 열고 /newbot 명령을 보낸 뒤, 발급된 토큰을 복사해 여기에 붙여넣으세요.",
  },
  hi: {
    ...
    telegramTooltip:
      "Telegram में अपना बॉट बनाएँ: @BotFather खोलें, /newbot कमांड भेजें, मिला हुआ टोकन कॉपी करें और यहाँ पेस्ट करें।",
  },
  id: {
    ...
    telegramTooltip:
      "Buat bot Anda sendiri di Telegram: buka @BotFather, kirim perintah /newbot, salin token yang diberikan dan tempel di sini.",
  },
  vi: {
    ...
    telegramTooltip:
      "Tạo bot của riêng bạn trong Telegram: mở @BotFather, gửi lệnh /newbot, sao chép token được cấp và dán vào đây.",
  },
  nl: {
    ...
    telegramTooltip:
      "Maak je eigen bot in Telegram: open @BotFather, stuur het commando /newbot, kopieer het ontvangen token en plak het hier.",
  },
};
