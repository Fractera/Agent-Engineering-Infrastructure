...
// НОВАЯ фраза (v2, шаг 298) — карандаш массового редактирования через Quiz ещё не перенесён (отдельный
// шаг). Добавление и удаление кейсов работают сейчас; карандаш показывает эту подсказку. Десять языков
// (CLAUDE.md 4г). Держится отдельным словарём, чтобы v1-блок выше оставался дословной копией.
const QUIZ_SOON: Record<string, string> = {
  en: "Editing with the Quiz comes in a later step — adding and deleting cases already work.",
  ru: "Редактирование через Quiz — в следующем шаге; добавление и удаление кейсов уже работают.",
  es: "La edición con el Quiz llega en un paso posterior — añadir y eliminar casos ya funciona.",
  fr: "L'édition avec le Quiz arrive dans une étape ultérieure — ajouter et supprimer des cas fonctionne déjà.",
  it: "La modifica con il Quiz arriverà in un passo successivo — aggiungere ed eliminare casi funziona già.",
  de: "Das Bearbeiten mit dem Quiz kommt in einem späteren Schritt — Hinzufügen und Löschen von Fällen funktioniert bereits.",
  pt: "A edição com o Quiz chega num passo posterior — adicionar e eliminar casos já funciona.",
  pl: "Edycja przez Quiz pojawi się w późniejszym kroku — dodawanie i usuwanie przypadków już działa.",
  tr: "Quiz ile düzenleme sonraki bir adımda gelecek — senaryo ekleme ve silme şimdiden çalışıyor.",
