...
// Приветствие новорождённой автоматизации (микросервис `components/welcome`, шаг 302) — builder-facing
// онбординг: пока нет ни одного кейса, уводит СТРОИТЕЛЯ в Quiz. Кокпит → десять языков; переехал из
// одноязычного хардкода стартера. Подключается тем же fail-silent дев-слотом.
export { Welcome } from "./components/welcome/client/welcome.client";
