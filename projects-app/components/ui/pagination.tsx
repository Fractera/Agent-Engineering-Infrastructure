...
// shadcn/ui Pagination — канонический компонент набора. Заведён в платформенный `components/ui`, а не
// написан руками внутри автоматизации: закон папки требует брать примитив shadcn и запрещает самопис.
...
type PaginationLinkProps = { isActive?: boolean; size?: "default" | "sm" | "lg" | "icon" } & React.ComponentProps<"button">;
